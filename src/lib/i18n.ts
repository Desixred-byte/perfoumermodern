...
export const translations = {
  az: {
    ...
    detail: {
      ...
      moreProducts: "Digər Premium Məhsullarımız",
  ...
  en: {
    ...
    detail: {
      ...
      moreProducts: "More Premium Products",
  ...
  ru: {
    ...
    detail: {
      ...
      moreProducts: "Другие премиальные ароматы",
